...
class Triangle(object):
    ...
    def area(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        len_a = self.a.distance_from(self.b)
        len_b = self.b.distance_from(self.c)
        len_c = self.c.distance_from(self.a)
    ...
    def return_doubled_triangle(self):
        ...
        #        They include the Example in the above doc-string.
        # -------------------------------------------------------------------------
        tri = Triangle(self.a.clone(), self.b.clone(), self.c.clone())
        tri.shrink_or_expand(2)
        return tri
